...
ExternalProject_Add(
    ...
    CMAKE_ARGS -DCMAKE_TOOLCHAIN_FILE=${CMAKE_TOOLCHAIN_FILE} -DCMAKE_INSTALL_PREFIX=${MIR2X_3RD_PARTY_DIR}/libzip/build/install -DCMAKE_BUILD_TYPE=Release -DBUILD_SHARED_LIBS=OFF
...
ADD_DEPENDENCIES(mir2x_3rds libzip)
