...
ExternalProject_Add(
    ...
    INSTALL_COMMAND ${CMAKE_AR} rcs ${MIR2X_3RD_PARTY_DIR}/aco/${CMAKE_STATIC_LIBRARY_PREFIX}aco${CMAKE_STATIC_LIBRARY_SUFFIX} acosw.o aco.o
    UPDATE_COMMAND ""
    PATCH_COMMAND ""
)
...
SET(ACO_LIBRARIES    "${CMAKE_STATIC_LIBRARY_PREFIX}aco${CMAKE_STATIC_LIBRARY_SUFFIX}")

INCLUDE_DIRECTORIES(SYSTEM ${ACO_INCLUDE_DIRS})
LINK_DIRECTORIES(${MIR2X_3RD_PARTY_DIR}/aco)
