 ...
 *  Last Modified: 03/09/2016 21:01:59
 *
...
{
    // parse all parameters for window
    // and then create window
    ...
    try{
	m_WindowDesktopMode = stXMLExt.NodeAtob("Root/Window/DesktopMode");
    }catch(...){
	m_WindowDesktopMode = true;
    }
