...
void PlayerStateBoard::drawEx(int, int, int, int, int, int) const
{
    ...
    LabelBoard(DIR_UPLEFT, 0, 0, str_printf(u8"%.2f", 12.11).c_str(), 1, 12, 0, colorf::WHITE + colorf::A_SHF(255)).drawAt(DIR_NONE, x() + 277, y() + 98 + 24 * 1);
    LabelBoard(DIR_UPLEFT, 0, 0, str_printf(u8"%.2f", 12.11).c_str(), 1, 12, 0, colorf::WHITE + colorf::A_SHF(255)).drawAt(DIR_NONE, x() + 277, y() + 98 + 24 * 2);
    LabelBoard(DIR_UPLEFT, 0, 0, str_printf(u8"%.2f", 12.11).c_str(), 1, 12, 0, colorf::WHITE + colorf::A_SHF(255)).drawAt(DIR_NONE, x() + 277, y() + 98 + 24 * 3);
