    ...
    , m_magicIconDataList
      {
          ...
          {DBCOM_MAGICID(u8"冰咆哮"  ), 0X05001020, 2, 3},
          {DBCOM_MAGICID(u8"魄冰刺"  ), 0X0500106D, 2, 4},

          // 雷
          {DBCOM_MAGICID(u8"霹雳掌"  ), 0X05001028, 0, 0},
          {DBCOM_MAGICID(u8"雷电术"  ), 0X0500100A, 0, 1},
          {DBCOM_MAGICID(u8"疾光电影"), 0X05001009, 2, 2},
          {DBCOM_MAGICID(u8"地狱雷光"), 0X05001017, 2, 3},
          {DBCOM_MAGICID(u8"怒神霹雳"), 0X0500106E, 2, 4},

          // 风
          {DBCOM_MAGICID(u8"风掌"    ), 0X05001042, 0, 0},
          {DBCOM_MAGICID(u8"击风"    ), 0X05001049, 0, 1},
          {DBCOM_MAGICID(u8"风震天"  ), 0X05001048, 2, 2},
          {DBCOM_MAGICID(u8"龙卷风"  ), 0X05001047, 2, 3},
          {DBCOM_MAGICID(u8"抗拒火环"), 0X05001007, 4, 1},
          {DBCOM_MAGICID(u8"魔法盾"  ), 0X0500101D, 4, 2},

          // 神圣
          {DBCOM_MAGICID(u8"治愈术"    ), 0X05001001, 0, 0},
          {DBCOM_MAGICID(u8"群体治愈术"), 0X0500101C, 0, 2},
          {DBCOM_MAGICID(u8"回生术"    ), 0X0500104C, 0, 3},
          {DBCOM_MAGICID(u8"月魂断玉"  ), 0X05001024, 2, 1},
          {DBCOM_MAGICID(u8"月魂灵波"  ), 0X05001025, 2, 2},
          {DBCOM_MAGICID(u8"云寂术"    ), 0X05001077, 4, 3},
          {DBCOM_MAGICID(u8"阴阳法环"  ), 0X05001079, 4, 4},
          ...
          {DBCOM_MAGICID(u8"强魔震法"  ), 0X05001058, 1, 3},
          {DBCOM_MAGICID(u8"猛虎强势"  ), 0X0500105D, 1, 4},
          {DBCOM_MAGICID(u8"隐身术"    ), 0X05001011, 2, 0},
          {DBCOM_MAGICID(u8"集体隐身术"), 0X05001012, 2, 1},
          {DBCOM_MAGICID(u8"妙影无踪"  ), 0X05001078, 2, 4},
          {DBCOM_MAGICID(u8"灵魂火符"  ), 0X0500100C, 3, 0},

          // 幻影
          {DBCOM_MAGICID(u8"召唤骷髅"    ), 0X0500103B, 0, 0},
          {DBCOM_MAGICID(u8"召唤神兽"    ), 0X0500101C, 0, 1},
          {DBCOM_MAGICID(u8"超强召唤骷髅"), 0X05001068, 0, 2},
          {DBCOM_MAGICID(u8"移花接玉"    ), 0X0500107A, 0, 3},
          {DBCOM_MAGICID(u8"诱惑之光"    ), 0X05001013, 2, 0},
          {DBCOM_MAGICID(u8"圣言术"      ), 0X0500101F, 2, 1},
          {DBCOM_MAGICID(u8"凝血离魂"    ), 0X0500106F, 2, 3},
          {DBCOM_MAGICID(u8"瞬息移动"    ), 0X05001014, 3, 0},
          {DBCOM_MAGICID(u8"异形换位"    ), 0X05001067, 3, 1},
          ...
          {DBCOM_MAGICID(u8"翔空剑法"  ), 0X05001022, 1, 4},
          {DBCOM_MAGICID(u8"十方斩"    ), 0X05001066, 1, 5},
          {DBCOM_MAGICID(u8"烈火剑法"  ), 0X05001019, 2, 4},
          {DBCOM_MAGICID(u8"莲月剑法"  ), 0X05001021, 2, 5},
          {DBCOM_MAGICID(u8"野蛮冲撞"  ), 0X0500101A, 3, 3},
          {DBCOM_MAGICID(u8"乾坤大挪移"), 0X0500106A, 3, 4},
          {DBCOM_MAGICID(u8"铁布衫"    ), 0X05001065, 3, 5},
          {DBCOM_MAGICID(u8"斗转星移"  ), 0X0500106B, 3, 6},
          {DBCOM_MAGICID(u8"破血狂杀"  ), 0X05001069, 3, 7},
          {DBCOM_MAGICID(u8"精神力战法"), 0X05001003, 4, 0},
          {DBCOM_MAGICID(u8"空拳刀法"  ), 0X05001023, 4, 3},
      }
