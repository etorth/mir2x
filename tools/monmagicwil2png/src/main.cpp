 ...
 *    Description: convert monster magic graphics res to png files, usage:
 *
 *                      monmagicwil2png mir2x_Data_path # data path
 *                                      out-dir         # output dir
 ...
 *                  there are files:
 *
 *                      /mnt/c/Users/anhong/Desktop/Data/MonMagic.wil
 *                      /mnt/c/Users/anhong/Desktop/Data/MonMagicEx.wil
 *                      /mnt/c/Users/anhong/Desktop/Data/MonMagicEx2.wil
 *                      /mnt/c/Users/anhong/Desktop/Data/MonMagicEx3.wil
 *                      /mnt/c/Users/anhong/Desktop/Data/MonMagicEx4.wil
 *
 *                  then issue command:
 *
 *                      monmagicwil2png /mnt/c/Users/anhong/Desktop/Data out-dir 4
 *
 *        Version: 1.0
 *       Revision: none
 *       Compiler: gcc
    ...
    for(int fileIndex = 0; const auto fileBodyName:
    {
        ...
        for(int i = 0; i < imgPackage.IndexCount(); ++i){
            if(imgPackage.SetIndex(i) && imgPackage.CurrentImageValid()){
                ...
                if(!pngf::saveRGBABuffer((uint8_t *)(pngBuf.data()), imgInfo.shWidth, imgInfo.shHeight, saveFileName)){
