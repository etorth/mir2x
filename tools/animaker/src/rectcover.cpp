...
bool RectCover::Overlap(const RectCover &)
{
    return false;
}
...
{
    return false
        || PointInTriangle<double>(fX, fY, m_MidX, m_MidY, m_X1, m_Y1, m_X2, m_Y2)
        || PointInTriangle<double>(fX, fY, m_MidX, m_MidY, m_MidX * 2.0 - m_X1, m_MidY * 2.0 - m_Y1, m_X2, m_Y2)
        || PointInTriangle<double>(fX, fY, m_MidX, m_MidY, m_MidX * 2.0 - m_X2, m_MidY * 2.0 - m_Y2, m_X1, m_Y1)
        || PointInTriangle<double>(fX, fY, m_MidX, m_MidY, m_MidX * 2.0 - m_X1, m_MidY * 2.0 - m_Y1, m_MidX * 2.0 - m_X2, m_MidY * 2.0 - m_Y2)
        ;
}
