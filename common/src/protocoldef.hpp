...
enum AuctionCategoryType: int
{
    AUCTIONCAT_NONE  = 0,
    AUCTIONCAT_BEGIN = 1,

    AUCTIONCAT_ALL = AUCTIONCAT_BEGIN,
    AUCTIONCAT_DRESS,
    AUCTIONCAT_WEAPON,
    AUCTIONCAT_NECKLACE,
    AUCTIONCAT_HELMET,
...
enum DirectTradeErrorType: uint8_t
{
    DTRADEERR_NONE = 0,
    DTRADEERR_BADTARGET,
    DTRADEERR_NOTALLOWED,
    DTRADEERR_TARGETNOTALLOWED,
    DTRADEERR_BUSY,
    DTRADEERR_TARGETBUSY,
    DTRADEERR_DEAD,
    DTRADEERR_TARGETDEAD,
    DTRADEERR_TOOFAR,
    DTRADEERR_REJECTED,
    DTRADEERR_OFFLINE,
    DTRADEERR_BADOFFER,
...
enum AuctionRegisterErrorType: int
{
    AUCTIONREGERR_NONE = 0,
    AUCTIONREGERR_BEGIN = 1,
    AUCTIONREGERR_BADITEM = 1,
    AUCTIONREGERR_BADPRICE,
    AUCTIONREGERR_BADNOTE,
    AUCTIONREGERR_END,
};
