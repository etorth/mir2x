...
#define _add_mpk_type_case(t) case t: return #t;
    switch(type){
        ...
        _add_mpk_type_case(MPK_SENDPACKAGE     )
        _add_mpk_type_case(MPK_RECVPACKAGE     )
        ...
        _add_mpk_type_case(MPK_QUERYSELLITEM   )
        ...
        _add_mpk_type_case(MPK_QUERYPLAYERLOOK )
        _add_mpk_type_case(MPK_QUERYPLAYERWEAR )
