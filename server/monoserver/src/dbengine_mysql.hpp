...
class DBEngine_MySQL: public DBConnection
{
    ...
    public:
        DBEngine_MySQL::DBEngine_MySQL(const char *szHostName, const char *szUserName, const char *szPassword, const char *szDBName, unsigned int nPort)
            : DBConnection()
        {
...
class DBRecord_MySQL: public DBRecord
{
    ...
    public:
       const char *Get(const char *szColumnName) override
       {
            if(!szColumnName){
