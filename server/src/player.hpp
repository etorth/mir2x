...
class Player final: public BattleObject
{
    ...
    protected:
        corof::entrance onActorMsg(const ActorMsgPack &);
    ...
    private:
        ...
        corof::entrance on_AM_GIFT               (const ActorMsgPack &);
        ...
        corof::entrance on_AM_BINDCHANNEL        (const ActorMsgPack &);
        ...
        corof::entrance on_AM_REMOVEGROUNDITEM   (const ActorMsgPack &);
        corof::entrance on_AM_QUERYUIDBUFF       (const ActorMsgPack &);
        corof::entrance on_AM_QUERYPLAYERNAME    (const ActorMsgPack &);
        corof::entrance on_AM_QUERYPLAYERWLDESP  (const ActorMsgPack &);
        corof::entrance on_AM_REMOTECALL         (const ActorMsgPack &);
        corof::entrance on_AM_REQUESTJOINTEAM    (const ActorMsgPack &);
        corof::entrance on_AM_REQUESTLEAVETEAM   (const ActorMsgPack &);
        corof::entrance on_AM_QUERYTEAMPLAYER    (const ActorMsgPack &);
        corof::entrance on_AM_QUERYTEAMMEMBERLIST(const ActorMsgPack &);
        corof::entrance on_AM_TEAMUPDATE         (const ActorMsgPack &);

    private:
        corof::entrance net_CM_ACTION                    (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_BUY                       (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_ADDFRIEND                 (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_ACCEPTADDFRIEND           (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_REJECTADDFRIEND           (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_BLOCKPLAYER               (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_CHATMESSAGE               (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_CONSUMEITEM               (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_DROPITEM                  (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_MAKEITEM                  (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_NPCEVENT                  (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_PICKUP                    (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_PING                      (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_QUERYCORECORD             (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_QUERYMAPBASEUID           (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_QUERYGOLD                 (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_QUERYPLAYERNAME           (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_QUERYPLAYERWLDESP         (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_QUERYCHATPEERLIST         (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_QUERYCHATMESSAGE          (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_QUERYSELLITEMLIST         (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_QUERYUIDBUFF              (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_REQUESTADDEXP             (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_REQUESTEQUIPBELT          (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_REQUESTEQUIPWEAR          (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_REQUESTGRABBELT           (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_REQUESTGRABWEAR           (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_REQUESTJOINTEAM           (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_REQUESTKILLPETS           (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_REQUESTLATESTCHATMESSAGE  (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_REQUESTLEAVETEAM          (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_REQUESTMAGICDAMAGE        (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_REQUESTRETRIEVESECUREDITEM(uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_REQUESTSPACEMOVE          (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_SETMAGICKEY               (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_SETRUNTIMECONFIG          (uint8_t, const uint8_t *, size_t, uint64_t);
        corof::entrance net_CM_CREATECHATGROUP           (uint8_t, const uint8_t *, size_t, uint64_t);
