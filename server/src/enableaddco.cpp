    ...
    : m_actorPod(argPod)
{
    ...
    m_actorPod->registerOp(AM_ADDCO, [this](const ActorMsgPack &mpk) -> corof::awaitable<>
    {
        return onMsgAddCO(mpk);
    });
}

corof::awaitable<> EnableAddCO::onMsgAddCO(const ActorMsgPack &mpk)
{
