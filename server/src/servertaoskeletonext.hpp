...
{
    public:
        ServerTaoSkeletonExt(uint64_t argMapUID, int argX, int argY, uint64_t masterUID)
            : ServerTaoSummon(DBCOM_MONSTERID(u8"超强骷髅"), argMapUID, argX, argY, DIR_DOWNLEFT, masterUID)
        {}
