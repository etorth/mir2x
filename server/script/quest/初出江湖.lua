                ...
                if level < 6 then
                    ...
                    [=[
                        <layout>
                            ...
                            <par>大老板道友就在道馆内。从这往下走，在右侧可以看到杂货店，进去就可以见到他了。杂货店入口的大概位置在<event id="npc_fly_to_loc" arg="{'道馆_1',394,169}" close="1">(394,169)</event>，请参考一下吧！</par>
                            <par></par>
                    ...
                    npc_accept_quest = function(uid, value)
                        ...
                        [=[
                            <layout>
                                ...
                                <par>从这出去再向右上方一直走就是阿潘道友所在的武器库入口。准确位置在<event id="npc_fly_to_loc" arg="{'道馆_1',429,120}" close="1">(429,120)</event>。</par>
                                <par></par>
            ...
            [[
                ...
                return setUIDQuestHandler(playerUID, questName,
                {
                    [SYS_ENTER] = function(uid, value)
                        ...
                        [=[
                            <layout>
                                <par>出去后向右上方一直走就是武器库的入口。位置在<event id="npc_fly_to_loc" arg="{'道馆_1',429,120}" close="1">(429,120)</event>，到阿潘道友后把道力护身符交给他。</par>
                                <par></par>
                                <par><event id="%%s">好的！</event></par>
                            </layout>
                        ]=], SYS_EXIT)
            ...
            [[
                ...
                return setUIDQuestHandler(playerUID, questName,
                {
                    [SYS_ENTER] = function(uid, value)
                        ...
                        [=[
                            <layout>
                                <par>大老板道友呆的杂货店在<event id="npc_fly_to_loc" arg="{'道馆_1',394,169}" close="1">(394,169)</event>那儿。快回去看看吧！</par>
                                <par></par>
                                <par><event id="%%s">结束</event></par>
                            </layout>
                        ]=], SYS_EXIT)
