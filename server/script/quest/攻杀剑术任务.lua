...
-- stop the clock and hand the copy back, whichever way the trial ended
--
...
setQuestFSMTable(
{
    ...
    -- Monclear/MonGen/TimeRecall/map, everything the teacher's next step did
...
[[
    ...
    {
        -- legacy left @mugong_yedo clickable forever and answered out of the flags, so this
