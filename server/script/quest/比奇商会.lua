        ...
        quest_accept_quest = function(uid, value)
            ...
            [[
                ...
                setUIDQuestHandler(playerUID, questName,
                {
                    ...
                    npc_discuss_2 = function(uid, value)
                        ...
                        [=[
                            <layout>
                                ...
                                <par></par>
                                <par><event id="npc_discuss_accepted">没问题！</event></par>
                                <par><event id="npc_discuss_refused">请给我点儿考虑的时间。</event></par>
                            </layout>
                        ]=], SYS_EXIT)
                    end,

                    npc_discuss_accepted = function(uid, value)
                        uidPostXML(uid, questPath,
                        [=[
                            <layout>
                    ...
                    npc_discuss_refused = function(uid, value)
                        uidPostXML(uid, questPath,
                        [=[
                            <layout>
                                <par>明白吗，年轻人？！</par>
