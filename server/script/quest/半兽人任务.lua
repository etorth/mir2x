        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    ...
                    {
                        '还没有关于半兽洞穴的调查结果吗？',
                        '看出异常征兆的地方就是<t color="red">半兽洞穴(65 : 174)1层附近(303 : 65)</t>，所以希望你在那儿附近仔细调查！',
                    },
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '哦，找到了有可疑迹象的地方但是入口被堵住了啊！',
                        '虽然有精通这方面的学者，不过现在却不知他的行踪啊！不过尽管如此，还是去找一下<t color="red">边境城市</t>一个叫做<t color="red">云发</t>的人吧！我也不知他的行踪到底<t wrap="0">···</t>？',
                    },
                    dialog.link('npc_ask_scholar', '云发现在哪儿呢？'))
                end,
                ...
                npc_ask_scholar = function(uid, args)
                    ...
                    {
                        '他本来在边境城市的。',
                        '不过据说后来失踪了。如果对天然洞穴最了解的他在的话，这事儿就好解决多了！可能他是有什么不能露面不能联络的事情<t wrap="0">···</t>',
                        '你就按照他夫人的嘱咐去天然洞穴找一下吧！',
                    },
                    dialog.link(SYS_EXIT, '结束'))
                end,
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '啊<t wrap="0">···</t>您是来找云发的<t wrap="0">···</t>',
                        '呜<t wrap="0">···</t>呜<t wrap="0">···</t>',
                    },
                    dialog.link('npc_ask_what', '出什么事儿了吗？'))
                end,

                npc_ask_what = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '他自从去调查天然洞穴走后就直到现在还没有回来！已经过了说好回来的日子好几天了，连个信儿都没有，所以我每天都是惶惑不安的独自度过的<t wrap="0">···</t>',
                        '呜呜<t wrap="0">···</t>真担心他出了什么事儿，实在是坚持不住了啊！',
                        '您一定要去把我在<t color="red">天然洞穴</t>的丈夫平安的找回来啊！如果您遇到了我丈夫的话，可能您就会知道您想要知道的事情的！',
                    },
                    dialog.link(SYS_EXIT, '结束'))
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '啊！老天爷啊<t wrap="0">···</t>到底把我的丈夫<t wrap="0">···</t>',
                        string.format('啊<t wrap="0">···</t> 只能拜托<t color="red">%s</t>您了<t wrap="0">···</t>', server.player.getName(uid)),
                        '如果您能把他平安的带回来我一定会好好报答您的！',
                    },
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    ...
                    {
                        '什么？你说我的老婆十分担心我？',
                        '可这用魔法锁住的屋子<t wrap="0">···</t>现在不是顾得上这个的时候<t wrap="0">···</t>',
                        '嗯，那么就不该在这儿这样费时间了啊！',
                    },
                    dialog.link('npc_go_back', '那就赶快回去吧！'))
                end,

                npc_go_back = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '那么应该快去找我的助手！虽然不久前我与他离散了，但他是个责任感很强的人，所以如果找不到我的话是不会出去的！',
                        '因为我一点儿武功都不会，所以一下子不能从这个地方出去<t wrap="0">···</t>你替我去找找他行吗？我的助手可能在<t color="red">半兽天然洞穴2层</t>的什么地方。',
                    },
                    dialog.link('npc_find_guard', '好的，我去找一下试试！'))
                end,
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    ...
                    {
                        '遇到我的丈夫了？啊！太感谢了！',
                        '他一切平安啊，他要找的助手就是护卫武士<t color="red">嘉登</t>先生啊！',
                        '快去找嘉登先生吧！洞中没有护卫武士只有他自己<t wrap="0">···</t>这可不行啊！',
                        '快快去找嘉登先生吧！',
                    },
                    dialog.link(SYS_EXIT, '结束'))
                end,
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '是被魔法锁住的屋子<t wrap="0">···</t>',
                        '这下又没辙了！现在要拜托你一下，快去找我的助手告诉他我在这儿！',
                        '我的助手可能在<t color="red">半兽天然洞穴2层</t>的什么地方！',
                    },
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '我是来这里调查矿产分布的学者的助手兼护卫武士。',
                        '但是由于应付怪兽的袭击把学者先生给丢了！',
                        '到底在哪呢？<t wrap="0">···</t>千万不要出什么事儿啊！',
                    },
                    dialog.link('npc_tell_found', '云发先生就在天然洞穴2层，他平安无事！'))
                end,

                npc_tell_found = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '云发先生平安无事啊！担心死我了，真是万幸啊！',
                        '这儿比较安全，我马上就去把他接过来！',
                    },
                    dialog.link('npc_guard_go', '云发先生也正在等着你呢！'))
                end,
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    ...
                    {
                        '顺利见到嘉登先生了啊！',
                        '谢谢<t wrap="0">···</t>但是<t wrap="0">···</t>啊<t wrap="0">···</t>他要完成研究啊！',
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    ...
                    {
                        '好不容易一行人又聚到一起了啊！谢谢啦！',
                        '在半兽洞穴被魔法锁住的屋子<t wrap="0">···</t>',
                        '唔<t wrap="0">···</t>魔法<t wrap="0">···</t>半兽人<t wrap="0">···</t>幸亏是和我最近研究的领域差不多的<t wrap="0">···</t>',
                    },
                    dialog.link('npc_ask_reason', '知道为什么进不去的理由了吗？'))
                end,

                npc_ask_reason = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '唔<t wrap="0">···</t>看来使半兽人的骷髅复活的魔法和这个地方有着某种联系的可能性确实很大啊！',
                        '那么可能半兽人有自己进入这个地方的办法。是固定的暗语还是特别的钥匙呢<t wrap="0">···</t>？可能是要有特别的钥匙才行。',
                        '或者<t wrap="0">···</t>能够进入这个地方的关键好像还是在半兽人那儿<t wrap="0">···</t>不知您能不能去<t color="red">比奇城城主</t>大人那儿问问有没有半兽人的异常征兆！还有，我还要继续留在这儿，如果还有什么要问的事儿的话，就来有嘉登看守的这里找我吧！',
                    },
                    dialog.link(SYS_EXIT, '结束'))
    ...
    quest_ask_key = function(uid, args)
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '或者<t wrap="0">···</t>能够进入这个地方的关键好像还是在半兽人那儿。不知道带着这种东西的半兽人在其他的地区会不会有什么动静，去比奇城城主大人那儿问问吧！',
                        '还有，我还要继续留在这儿，如果还有什么要问的事儿的话，就来有嘉登看守的这里找我吧！唉<t wrap="0">···</t>真想快点结束调查回到我妻子身边啊！',
                    },
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
        ...
        [[
            ...
            return
            {
                [SYS_LABEL] = '禀报云发的推断',
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath, '遇到云发了！那么就去他那儿问一下半兽洞穴的困魔咒是怎么回事儿吧！',
                    dialog.link('npc_report_seal', '云发说要一把特别的钥匙才行。'))
                end,

                npc_report_seal = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '嗯<t wrap="0">···</t>让半兽人的骷髅复活的魔法和那个地方有着某种关联的可能性看来很大啊！',
                        '这样啊<t wrap="0">···</t>我觉得非同寻常啊，到底是暗号呢<t wrap="0">···</t>还是特别的钥匙<t wrap="0">···</t>半兽人<t wrap="0">···</t>半兽人的<t wrap="0">···</t>那么还是去道观周围探查一下吧！既然最近那儿半兽人的活动频繁<t wrap="0">···</t>没准就有知道什么线索的人呢！',
                    },
                    dialog.link('npc_ask_who', '该找谁打听呢？'))
                end,
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    ...
                    dialog.link('npc_ask_special', '真是让你受苦了，可是或许您知道<t wrap="0">···</t>'))
                end,

                npc_ask_special = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '你问半兽人有没有拿着什么特别的东西<t wrap="0">···</t>？',
                        '嗯<t wrap="0">···</t>这个，最近好像没有什么特别的啊<t wrap="0">···</t>',
                        '不过跟这个比起来，最近<t color="red">王铁匠</t>好像遇到了不少麻烦，你有什么帮助他的办法吗？',
                    },
                    dialog.link(SYS_EXIT, '结束'))
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '半兽人拿着的特别的东西<t wrap="0">···</t>唔<t wrap="0">···</t>好像没有什么啊<t wrap="0">···</t>',
                        '不过最近看到王铁匠由于丢了铁锤十分伤心的样子，我就感到十分心疼啊<t wrap="0">···</t>',
                    },
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '你可能已经听华玉那儿听说了吧，由于遭受了好几次洗劫，现在店里已经没什么可用的东西了！',
                        '如果是其他的东西也就算了，但可一定要找回我的铁锤才行啊！你有所不知，对于我们铁匠来说，铁锤就是和性命一样重要的东西啊！况且那还是用千年木制成的珍品呢！',
                    },
                    dialog.link('npc_hear_hammer', '竟有这样的事儿！'))
                end,

                npc_hear_hammer = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '所以就拜托您了！这附近的混蛋<t color="red">半兽人</t>中应该有一个拿着我铁锤的家伙，请你去帮我找回来吧！',
                        '我一定会报答你的！',
                    },
                    {
                        dialog.link('npc_ask_where', '我的铁锤会在哪儿呢？'),
                        dialog.link(SYS_EXIT, '结束'),
                    })
                end,
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '把我的铁锤找回来了啊！太谢谢你啦！这个铁锤被半兽人抢走后不知道我有多么伤心呢<t wrap="0">···</t>',
                        '可是<t wrap="0">···</t>虽然您这么辛苦帮我回了铁锤，却不知哪一天就又会被抢走！可能那时候我连命都也会搭进去呢！只有能够除掉那个<t color="red">半兽勇士</t>，让半兽人像以前那样不敢为非作歹，这事情才算完全的解决了啊<t wrap="0">···</t>唉！',
                    },
                    dialog.link('npc_hand_hammer', '我会做到的！'))
                end,
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    ...
                    {
                        '你问半兽人有没有拿着的什么特别的东西？',
                        '这个<t wrap="0">···</t>谁知道呢<t wrap="0">···</t>让我想想<t wrap="0">···</t>哦，对了，好像不久前看见过一个<t color="red">半兽人战士</t>脖子上带了一个样子很奇怪的<t color="red">角笛</t>。虽然一次都没有听见过那半兽人吹笛子的声音，但是那个东西好像有点奇怪啊！',
                        '不过我也不知道那个半兽勇士在哪儿，可能在某个洞穴里藏着吧<t wrap="0">···</t>',
                    },
                    dialog.link('npc_hunt_horn', '我去找找那个角笛！'))
                end,
    ...
    quest_hunt_horn = function(uid, args)
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '唉！真是太吃力了，快要挺不住了<t wrap="0">···</t>',
                        '唔<t wrap="0">···</t>跟你这样的人诉苦也没什么用<t wrap="0">···</t>',
                    },
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
        ...
        [[
            ...
            return
            {
                [SYS_LABEL] = '和智善说话',
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath, '这个人继续工作的时候我也不能放心的睡大觉啊！',
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
        ]])
        ...
        [[
            ...
            return
            {
                [SYS_LABEL] = '禀报角笛的线索',
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath, '角笛<t wrap="0">···</t>一定有什么特别的联系，去找找吧～！',
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
        ]])
        ...
        [[
            ...
            return
            {
                [SYS_LABEL] = '告诉云发角笛的事',
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath, '角笛<t wrap="0">···</t>难道是角笛？去找找吧！显然是有关系的东西！',
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
        ]])
    ...
    quest_hunt_warrior = function(uid, args)
        ...
        [[
            ...
            return
            {
                [SYS_LABEL] = '禀报角笛的线索',
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath, '找到了角笛<t wrap="0">···</t>既然叫做角笛<t wrap="0">···</t>那么赶快去半兽洞穴二层调查一下那个奇怪的屋子吧！',
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
        ]])
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '果然是角笛呀<t wrap="0">···</t>不管怎么样真的要出大问题了<t wrap="0">···</t>快去半兽洞穴调查一下吧！',
                        '显然是通过魔法才能做到的！',
                    },
                    dialog.link(SYS_EXIT, '结束'))
                end,
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '啊<t wrap="0">···</t>虽然不希望是那样<t wrap="0">···</t>到底是不死牌啊！快去比奇城城主大人那儿看看吧！',
                        '虽然我也想跑去，可我这身子骨儿<t wrap="0">···</t>去不了啊！',
                    },
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    if not server.player.hasItem(uid, '半块不死牌', 1) then
                        dialog.post(uid, questPath, '还没有关于半兽洞穴的调查结果吗？',
                        dialog.link(SYS_EXIT, '结束'))
                        return
                    end
                    ...
                    dialog.post(uid, questPath,
                    {
                        '噢？你说这就是藏着那恶毒的魔法秘密的东西？',
                        '我果然没有看错人啊！真是太辛苦了！现在终于可以阻止半兽人集结不死的军队来进攻比奇省的事态了！',
                        '可是<t wrap="0">···</t>现在还是没法儿安心下来！因为我们现在还没有对这个来历不明的魔法有完全的了解，万一什么时候这些半兽人再次策划这样的阴谋呢？还是这次就斩草除根为妙啊！',
                        '所以还是再拜托你一件事儿，去找到<t color="red">云发</t>把他带到我这儿来。因为这件事看起来是个非比寻常的问题，所以让他马上放下手中的事儿跟你来我这儿！',
                    },
                    dialog.link('npc_hand_half', '剩下的事儿我跟先生分析分析这个东西后再决定吧！'))
                end,
    ...
    quest_fetch_scholar = function(uid, args)
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    ...
                    dialog.link('npc_scholar_home', '那么比奇省再会！'))
                end,
        ...
        [[
            ...
            return
            {
                [SYS_LABEL] = '和嘉登说话',
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath, '我也打算马上回比奇省。',
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
        ]])
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    ...
                    {
                        '您说比奇城城主大人下令让云发回来？',
                        '现在马上就能见到云发了！谢谢你告诉我啊<t wrap="0">···</t>',
                    },
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    ...
                    dialog.link('npc_take_reward', '这只是我应该做的事儿啊<t wrap="0">···</t>可是云发先生<t wrap="0">···</t>？'))
                end,
                ...
                npc_take_reward = function(uid, args)
                    ...
                    {
                        '云发很担心自己的妻子就先回家去了！',
                        '他说用自己家的设备来分析一下不死牌，不知道现在有没有什么结果了。你去<t color="red">边境城市</t>的云发先生家里打听一下有什么分析结果吧！',
                    },
                    dialog.link(SYS_EXIT, '结束'))
    ...
    quest_ask_analysis = function(uid, args)
        ...
        [[
            ...
            return
            {
                [SYS_LABEL] = '关于不死牌',
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath, '现在可能分析完不死牌了吧！你去趟边境城市跟云发先生打听一下有什么结果吧！',
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
        ]])
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        ...
                        '哦，对了，对不死牌的分析刚刚结束！这其实是古代的遗物，而并非是半兽人所制，只是偶然间流落到了半兽人手中！半兽人那样的家伙是造不出这样的东西的<t wrap="0">···</t>',
                    },
                    dialog.link('npc_ask_more', '原来如此啊！'))
                end,

                npc_ask_more = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '所以只要把这个东西毁掉的话，半兽人就无法使用魔法了。不过这不死牌原本是由两半合二为一组成的，现在我们只有这半块儿，所以一定要找到那另外的半块儿！',
                        '我觉得这所有的事情的幕后都是由那个最近聚集势力的半兽勇士搞得鬼。您有找到这剩下的半块儿不死牌的力量，那么一定能找到那个半兽勇士。',
                        '关于半兽勇士的情报请去告诉比奇城城主大人。我来这里的时候收集了各处的情报，现在可以掌握大概的位置了。',
                    },
                    dialog.link('npc_take_half', '知道了！我会在比奇省转告这些的！'))
                end,
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '果然！这一系列的事件都和幕后的骷髅精灵有关！那么去除掉骷髅精灵，再找到剩下的半块不死牌毁掉它的话，所有的事情就可以结束了！',
                        '好吧！那么再拜托您去办点儿事！不管怎么样还是让你这样手腕高明智勇双全的人把这件事儿全部办妥了我才能安心啊～！',
                        string.format('如果你能除掉骷髅精灵的话我会额外重赏你的！，一定要让骷髅精灵最后死在不是您的部下，而是<t color="red">%s</t>您的手中才行啊！', server.player.getName(uid)),
                        '如果这阵子的情报准确的话，那么骷髅精灵的藏身之所必然是在<t color="red">半兽洞穴2层(255 : 281)</t>的某个地方。',
                    },
                    dialog.link(SYS_EXIT, '结束'))
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '骷髅精灵显然在<t color="red">半兽洞穴2层(255 : 281)</t>的什么地方<t wrap="0">···</t>',
                        string.format('一定要让骷髅精灵最后死在不是您的部下，而是<t color="red">%s</t>您的手中才行啊！', server.player.getName(uid)),
                    },
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
    ...
    quest_final = function(uid, args)
        ...
        [[
            ...
            return
            {
                [SYS_LABEL] = '和云发说话',
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath, '关于不死牌的处理问题现在正在和边境城市的云发先生商议之中。',
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
        ]])
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '欢迎光临！',
                        '多亏您帮忙我的丈夫才能平安无事的回来！',
                        '真心的感谢您！不知该怎么报答您的大恩大德<t wrap="0">···</t>',
                    },
                    dialog.link('npc_take_gift', '我也很高兴能帮助你！'))
                end,
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    ...
                    {
                        '噢！这就是不死牌的真面目啊！',
                        '那么骷髅精灵呢<t wrap="0">···</t>？啊，是嘛？没有了骷髅精灵，那么那些半兽人现在也就树倒猢狲散了！',
    ...
    setQuestHandler(questName,
    {
        ...
        [SYS_ENTER] = function(uid, args)
            if server.player.getQuestState(uid, prequestName) ~= SYS_DONE then
                ...
                {
                    '本官的事儿，可不是随便什么人都能插手的。',
                    '先去把<t color="red">王大人</t>的事情办妥了再来见我吧！',
                },
                dialog.link(SYS_EXIT, '结束'))
                return
            end
            ...
            if server.player.getLevel(uid) < minQuestLevel then
                dialog.post(uid, questPath,
                {
                    '好像你就是帮助王大人解决了他的事情的那个人吧！',
                    string.format('不过你的等级还没有超过<t color="red">%d级</t>，很难帮助本官我啊！', minQuestLevel),
                },
                dialog.link(SYS_EXIT, '结束'))
                return
            end

            dialog.post(uid, questPath, '您不就是帮助王大人解决了他的事情的那个人吗？',
            dialog.link('npc_confirm_self', '正是在下。'))
        end,

        npc_confirm_self = function(uid, args)
            dialog.post(uid, questPath,
            {
                '那太好了！我正好在找像您这样手腕高明的人呢',
                '我想要拜托您去调查一下和最近比奇省周围蓄积势力的半兽人有关的事儿，你有接受的勇气吗？',
            },
            {
                dialog.link('npc_accept_quest', '好啊！我一定全力以赴。'),
                dialog.link('npc_ask_detail', '我想先听听详细的事情。'),
            })
        end,
        ...
        npc_ask_detail = function(uid, args)
            dialog.post(uid, questPath,
            {
                ...
                '最近总是传来半兽人忽然集结势力在筹划着不寻常的阴谋的消息。大概好像是半兽人正在为了进攻比奇省，在已经死去了的自己同族的骷髅上施下魔法造出骷髅兵士。',
            },
            {
                dialog.link('npc_accept_quest', '明白了。这件事儿就交给我吧！'),
                dialog.link('npc_need_time', '给我点时间考虑一下吧！'),
            })
        end,
        ...
        npc_need_time = function(uid, args)
            ...
            {
                dialog.link('npc_reconsider', '我考虑好了。'),
                dialog.link('npc_take_longer', '再给我一点儿考虑的时间吧！'),
            })
        end,
        ...
        npc_reconsider = function(uid, args)
            ...
            {
                '决定了吗？',
                '现在很难找到像你这样合适的人选去做这件事儿啊～！',
            },
            {
                dialog.link('npc_accept_brief', '明白了。这件事儿就交给我吧！'),
                dialog.link('npc_take_longer', '再给我一点儿考虑的时间吧！'),
            })
        end,

        npc_take_longer = function(uid, args)
            dialog.post(uid, questPath, '慎重考虑一下吧，不过可不要拖得太久哦！',
            dialog.link(SYS_EXIT, '结束'))
        end,
        ...
        npc_accept_brief = function(uid, args)
            ...
            {
                '我要你做的事情很简单。',
                '就是去调查半兽洞穴和它们制造骷髅兵士的魔法，如果可能的话就把它毁掉或者拿到这儿来！' ..
                '目前根据调查能够看到异常征兆的地方就是<t color="red">半兽洞穴(65 : 174)1层附近(303 : 65)</t>，所以希望你在那儿附近仔细调查！',
                '祝你成功啊！',
            },
            dialog.link(SYS_EXIT, '结束'))
        ...
        npc_accept_quest = function(uid, args)
            dialog.post(uid, questPath,
            {
                '虽然已经派出了好多人，但大部分不是毫无所得而归，就是有去无回啊！不过我觉得像您这样智勇双全手腕高明的人一定可以把这件事情做好！',
