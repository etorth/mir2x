            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        ...
                        '虽然有精通这方面的学者，不过现在却不知他的行踪啊！ 不过尽管如此，还是去找一下<t color="red">边境城市</t>一个叫做<t color="red">云发</t>的人吧！我也不知他的行踪到底……？',
                    },
                    dialog.link('npc_ask_scholar', '云发现在在哪儿呢？'))
                end,
                ...
                npc_ask_scholar = function(uid, args)
                    ...
                    {
                        '他本来在边境城市的。',
                        '不过据说后来失踪了。如果对天然洞穴最了解的他在的话，这事儿就好解决多了！可能他是有什么不能露面不能联络的事情……',
                        '你就按照他夫人的嘱咐去天然洞穴找一下吧！',
                    },
                    dialog.link(SYS_EXIT, '结束'))
                end,
        ...
        [[
            ...
            return
            {
                ...
                npc_ask_what = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '他自从去调查天然洞穴走后就直到现在还没有回来！已经过了说好回来的日子好几天了，连个信儿都没有，所以我每天都是惶惑不安的独自度过的……',
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    ...
                    {
                        '啊！老天爷啊……到底把我的丈夫……',
                        string.format('啊…… 只能拜托<t color="red">%s</t>您了……', server.player.getName(uid)),
            ...
            return
            {
                ...
                npc_go_back = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        ...
                        '因为我一点儿武功都不会，所以一下子不能从这个地方出去……你替我去找找他行吗？我的助手可能在<t color="red">半兽天然洞穴 2层</t>的什么地方。',
                    },
        ...
        [[
            ...
            return
            {
                ...
                npc_ask_reason = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '唔……看来使半兽人的骷髅复活的魔法和这个地方有着某种联系的可能性确实很大啊！',
                        '那么可能半兽人有自己进入这个地方的办法。是固定的暗语还是特别的钥匙呢……？可能是要有特别的钥匙才行。',
                        '或者…能够进入这个地方的关键好像还是在半兽人那儿……不知您能不能去<t color="red">比奇城城主</t>大人那儿问问有没有半兽人的异常征兆！还有，我还要继续留在这儿， 如果还有什么要问的事儿的话，就来有嘉登看守的这里找我吧！',
                    },
                    dialog.link(SYS_EXIT, '结束'))
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '或者…能够进入这个地方的关键好像还是在半兽人那儿。不知道带着这种东西的半兽人在其他的地区会不会有什么动静，去比奇城城主大人那儿问问吧！',
                        '还有，我还要继续留在这儿， 如果还有什么要问的事儿的话，就来有嘉登看守的这里找我吧！唉……真想快点结束调查回到我妻子身边啊！',
                    },
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
        ...
        [[
            ...
            return
            {
                ...
                npc_report_seal = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '嗯……让半兽人的骷髅复活的魔法和那个地方有着某种关联的可能性看来很大啊！',
                        '这样啊……我觉得非同寻常啊，到底是暗号呢…还是特别的钥匙…半兽人…半兽人的…那么还是去道观周围探查一下吧！既然最近那儿半兽人的活动频繁…没准就有知道什么线索的人呢！',
                    },
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    ...
                    dialog.link('npc_ask_special', '真是让你受苦了，可是或许您知道……'))
                end,
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '半兽人拿着的特别的东西……唔……好像没有什么啊……',
                        '不过最近看到王铁匠由于丢了铁锤十分伤心的样子，我就感到十分心疼啊……',
                    },
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
        ...
        [[
            ...
            return
            {
                ...
                npc_ask_where = function(uid, args)
                    dialog.post(uid, questPath, '我的铁锤可能被这附近的其中一个半兽人拿着呢……',
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
        ]])
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '把我的铁锤找回来了啊！太谢谢你啦！这个铁锤被半兽人抢走后不知道我有多么伤心呢……',
                        '可是……虽然您这么辛苦帮我回了铁锤，却不知哪一天就又会被抢走！可能那时候我连命都也会搭进去呢！只有能够除掉那个<t color="red">半兽勇士</t>，让半兽人像以前那样不敢为非作歹，这事情才算完全的解决了啊……唉！',
                    },
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    ...
                    {
                        '你问半兽人有没有拿着的什么特别的东西?',
                        '这个…谁知道呢……让我想想……哦，对了，好像不久前看见过一个<t color="red">半兽人战士</t>脖子上带了一个样子很奇怪的<t color="red">角笛</t>。虽然一次都没有听见过那半兽人吹笛子的声音，但是那个东西好像有点奇怪啊！',
    ...
    quest_hunt_horn = function(uid, args)
        ...
        [[
            ...
            return
            {
                [SYS_LABEL] = '禀报角笛的线索',
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath, '角笛……一定有什么特别的联系，去找找吧～！',
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
        ]])
        ...
        [[
            ...
            return
            {
                [SYS_LABEL] = '告诉云发角笛的事',
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath, '角笛……难道是角笛？去找找吧！显然是有关系的东西！',
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
        ]])
    ...
    quest_hunt_warrior = function(uid, args)
        ...
        [[
            ...
            return
            {
                [SYS_LABEL] = '禀报角笛的线索',
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath, '找到了角笛……既然叫做角笛……那么赶快去半兽洞穴二层调查一下那个奇怪的屋子吧！',
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
        ]])
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '果然是角笛呀……不管怎么样真的要出大问题了……快去半兽洞穴调查一下吧！',
                        '显然是通过魔法才能做到的！',
                    },
                    dialog.link(SYS_EXIT, '结束'))
                end,
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '啊……虽然不希望是那样……到底是不死牌啊！快去比奇城城主大人那儿看看吧！',
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    ...
                    dialog.post(uid, questPath,
                    {
                        ...
                        '可是……现在还是没法儿安心下来！因为我们现在还没有对这个来历不明的魔法有完全的了解，万一什么时候这些半兽人再次策划这样的阴谋呢？还是这次就斩草除根为妙啊！',
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    ...
                    dialog.link('npc_take_reward', '这只是我应该做的事儿啊…… 可是云发先生……?'))
                end,
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        ...
                        '哦，对了，对不死牌的分析刚刚结束！这其实是古代的遗物，而并非是半兽人所制，只是偶然间流落到了半兽人手中！半兽人那样的家伙是造不出这样的东西的……',
                    },
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '骷髅精灵显然在<t color="red">半兽洞穴2层 (255 : 281)</t>的什么地方……',
