    ...
    [SYS_ENTER] = function(uid, args)
        ...
        [[
            ...
            return
            {
                [SYS_LABEL] = '关于沃玛神殿的古董',
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath, '据说王大人喜欢收集这些古董，去比奇省看看怎么样？',
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    if not server.player.hasItem(uid, '沃玛金牌', 1) then
                        dialog.post(uid, questPath, '好像没有带着沃玛金牌啊！这是怎么回事儿？',
                        dialog.link(SYS_EXIT, '结束'))
                        return
                    end

                    dialog.post(uid, questPath, '您又为何事而来呢？',
                    dialog.link('npc_show_medal', '给你看沃玛金牌来了！'))
                end,

                npc_show_medal = function(uid, args)
                    dialog.post(uid, questPath, '哦！真是很久以前的古董了啊!能告诉我这是什么东西吗？',
                    dialog.link('npc_dont_know', '在沃玛神殿中偶然得到的，但我也不知道是什么东西。'))
                end,
                ...
                npc_dont_know = function(uid, args)
                    ...
                    {
                        dialog.link('npc_sell', '好的，卖给你！'),
                        dialog.link('npc_keep', '现在还不想卖！'),
                    })
                end,
                ...
                npc_sell = function(uid, args)
                    ...
                    elseif server.player.getQuestState(uid, '比奇商会') ~= nil then
                        ...
                        dialog.post(uid, questPath, '那么给你五万钱！',
                        dialog.link('npc_thanks', '谢谢！'))
                ...
                npc_thanks = function(uid, args)
                    dialog.post(uid, questPath, '呵呵！越看越神奇啊!对了，你听说过关于那个有很多沃玛神殿中物品的老人的故事吗？',
                    dialog.link('npc_never_heard', '没有，没听过！'))
                end,

                npc_never_heard = function(uid, args)
                    dialog.post(uid, questPath,
                    '有传闻说在道馆附近的什么地方有一位独自生活的老人，他有很多过去沃玛教中曾经使用过的古董。' ..
                    '我也听说了这事儿并派人去他那儿买，可是都失败了！' ..
                    '如果你去沃玛神殿附近打猎的时候遇到那个老人的话，就告诉他我王某人想要出高价购买他的东西！' ..
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '去找住在道馆附近的老人转告他我王某人要出高价购买跟沃玛教有关的古董。那个无名老人隐居在<t color="red">道馆西北部的小山谷里</t>的一个小茅屋中，不过<t color="red">进入他隐居地的入口</t>可不太好找！',
                        '不知道那个老人是有何种内力的人啊！',
                    },
                    dialog.link(SYS_EXIT, '结束'))
                end,
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    if not server.player.hasItem(uid, '无名日志', 1) then
                        dialog.post(uid, questPath, '还是别进沃玛神殿啦！为了贪图宝物可是会丢了性命的！我可是警告你了啊！',
                        dialog.link(SYS_EXIT, '结束'))
                        return
                    end

                    dialog.post(uid, questPath, '这，这不是我不久前丢失的日志嘛！',
                    dialog.link('npc_ask_temple', '不能告诉我跟沃玛神殿有关的事情吗？'))
                end,
                ...
                npc_ask_temple = function(uid, args)
                    ...
                    },
                    {
                        ...
                        dialog.link('npc_threaten', '这么慌张的样子，看来是有什么不可告人的勾当吧！我要去衙门告发你！'),
                    })
                end,
                ...
                npc_ask_after = function(uid, args)
                    dialog.post(uid, questPath,
                    '邪教徒们坚信如果召唤出这超越性的存在就能得到援助，所以不顾数量劣势地进行殊死抵抗，熟悉了内部构造和适应了黑暗的教徒们与官兵大战了三天三夜，重创了官兵们。' ..
                    '但是那时却发生了未曾预料到的事情，寺庙中充斥的血腥味儿让“那个”睁开了眼睛。',
                    dialog.link('npc_ask_king', '难道“那个”就是沃玛教主？'))
                end,
                ...
                npc_ask_survivor = function(uid, args)
                    ...
                    {
                        dialog.link('npc_accept_help', '我会尽全力帮您的！'),
                        dialog.link('npc_refuse_help', '我可不想去做那么危险的事情！'),
                    })
                end,
                ...
                npc_accept_help = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '有了你的帮助，我就看到了希望啊！那么我来告诉你这办法吧！',
                        '沃玛教主原本是通过人身供养而制造出的<t color="red">灵魂明珠</t>才复活的。' ..
                        '也就是说，灵魂明珠是通过残忍的牺牲祭礼封入死去的冤魂而制造出来的。' ..
                        '但当时邪教徒们由于中途受到官兵攻击而没能彻底完成灵魂明珠。' ..
                        '因此沃玛教主自身的力量并没能完全的发挥出来，只是用它打开了阴间之门唤出了部下们。' ..
    ...
    quest_ask_wang = function(uid, args)
        ...
        [[
            ...
            return
            {
                [SYS_LABEL] = '和无名老人说话',
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath, '快去王大人那儿要回那个金牌吧！那可是非常重要的东西，是除掉沃玛教主必需的东西！',
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
        ]])
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    ...
                    dialog.link('npc_want_medal', '我是为要回沃玛金牌而来的！'))
                end,
    ...
    quest_find_bell = function(uid, args)
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '嗯！你说贸易商要求用其他能代替沃玛金牌的东西吗？咳！那个人也必须给当地土著送这种东西做礼物，实在是没办法啊！',
        ...
        [[
            ...
            return
            {
                [SYS_LABEL] = '和无名商人说话',
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath, '还没找来交换沃玛金牌的东西吗？离我要出发去沙漠的日子已经没有几天了，你还是尽快吧！',
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
        ]])
            ...
            return
            {
                ...
                npc_offer_search = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        ...
                        '具体的位置在<t color="red">沃玛神殿1层的207:47</t>附近。' ..
                        '可能仔细观察周围的石堆就会发现机关装置。' ..
                        '不过要准确的操作那些机关才行。' ..
    ...
    quest_open_vault = function(uid, args)
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '具体的位置在沃玛神殿1层的207:47附近。可能仔细观察周围的石堆就会发现机关装置。',
                        '发现了装置一定要小心操作啊！',
                    },
                    dialog.link(SYS_EXIT, '结束'))
                end,
        ...
        [[
            ...
            return
            {
                [SYS_LABEL] = '查看石堆',
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath, '石堆之间露出一处古旧的机关装置。',
                    dialog.link('npc_pull_lever', '小心地扳动机关。'))
                end,

                npc_pull_lever = function(uid, args)
                    dialog.post(uid, questPath, '石堆缓缓移开，露出了通往祭礼间的暗道。',
                    dialog.link(SYS_EXIT, '进去看看'))
        ...
        [[
            ...
            return
            {
                [SYS_LABEL] = '查看书架',
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath, '积满灰尘的书架上摆着一口小巧的古钟，钟身上刻满了扭曲的人脸。',
                    dialog.link('npc_take_bell', '取走那口钟。'))
                end,
    ...
    quest_trade_bell = function(uid, args)
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    if not server.player.hasItem(uid, '地狱神钟', 1) then
                        dialog.post(uid, questPath, '地狱神钟哪儿去了？如果没有那个的话就拿不来沃玛金牌了！',
                        dialog.link(SYS_EXIT, '结束'))
                        return
                    end

                    dialog.post(uid, questPath, '对，就是那个东西！用那个东西的话就完全可以拿回沃玛金牌了！',
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
        ]])
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    if not server.player.hasItem(uid, '地狱神钟', 1) then
                        dialog.post(uid, questPath, '地狱神钟在哪儿啊？要是打算骗我的话，还是算了吧！',
                        dialog.link(SYS_EXIT, '结束'))
                        return
                    end

                    dialog.post(uid, questPath, '带来可以代替沃玛金牌的东西了？',
                    dialog.link('npc_show_bell', '这个宝物是地狱神钟。'))
                end,
    ...
    quest_hunt_orb = function(uid, args)
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    if not server.player.hasItem(uid, '沃玛金牌', 1) then
                        dialog.post(uid, questPath, '沃玛金牌在哪儿呢？你难道忘了那是除掉沃玛教主所必需的东西了吗？',
                        dialog.link(SYS_EXIT, '结束'))
                        return
                    end

                    dialog.post(uid, questPath, '拿来沃玛金牌了？',
                    dialog.link('npc_hand_medal', '是的，从贸易商那儿拿回沃玛金牌了！'))
                end,

                npc_hand_medal = function(uid, args)
                    dialog.post(uid, questPath, '做得好！现在已经拿到了沃玛金牌，终于该轮到去夺取灵魂明珠了！因为灵魂明珠被<t color="red">沃玛护卫</t>们轮流看守着，所以不太好找！不过如果您要是能够消灭所有沃玛护卫的话，也没有找不到的道理！',
                    dialog.link('npc_hunt_guard', '对沃玛护卫们见一个杀一个就能找到灵魂明珠。'))
                end,
    ...
    quest_find_orb = function(uid, args)
        ...
        [[
            ...
            return
            {
                [SYS_LABEL] = '和无名老人说话',
                [SYS_ENTER] = function(uid, args)
                    dialog.post(uid, questPath, '灵魂明珠在哪儿？难道还没能找来吗？',
                    dialog.link(SYS_EXIT, '结束'))
                end,
            }
        ]])
        ...
        [[
            ...
            return
            {
                ...
                npc_ask_break = function(uid, args)
                    dialog.post(uid, questPath, '就是这个！我已经老了没有力气，你能来帮我把这个弄碎吗？',
                    {
                        dialog.link('npc_throw', '扔到地上。'),
                        dialog.link('npc_headbutt', '用头碰撞。'),
                        dialog.link('npc_smash', '用武器向下打。'),
                    })
                end,
                ...
                npc_headbutt = function(uid, args)
                    dialog.post(uid, questPath, '用一下此外别的办法，试试用头碰撞一下吧！',
                    dialog.link('npc_ask_break', '后退'))
                end,
                ...
                npc_go_hall = function(uid, args)
                    dialog.post(uid, questPath,
                    {
                        '过去沃玛教的祭司们居住的祭司馆在沃玛神殿3层，据我所知灵魂明珠就是在那儿制造的，也许那儿有破坏它的办法。' ..
                        '虽然进入祭司馆需要用沃玛金牌，但是你已经找到了沃玛金牌，所以没什么问题。' ..
                        '进去后就好好调查里面一下吧！',
                        '去调查一下在沃玛神殿3层的祭司馆吧！对了，不要忘了带上沃玛金牌！祭司馆在沃玛神殿2层的最北部附近，进去的入口被隐藏了，找起来可能有点难！',
                    },
                    dialog.link(SYS_EXIT, '结束'))
    ...
    quest_meet_priest = function(uid, args)
        ...
        [[
            ...
            return
            {
                ...
                [SYS_ENTER] = function(uid, args)
                    if not server.player.hasItem(uid, '灵魂明珠', 1) then
                        dialog.post(uid, questPath, '难道您不知道灵魂明珠的去向吗？',
                        dialog.link(SYS_EXIT, '结束'))
                        return
                    end

                    dialog.post(uid, questPath, '快请进。是带着灵魂明珠的人吧！',
                    dialog.link('npc_ask_who', '您是谁？'))
                end,
                ...
                npc_i_see = function(uid, args)
                    dialog.post(uid, questPath, '那个灵魂明珠是非常危险的东西，我要把它带回道馆和众位道友用道力来净化一下。把那个灵魂明珠交给我吧！',
                    dialog.link('npc_hand_orb', '好的。'))
                end,

                npc_hand_orb = function(uid, args)
                    if not server.player.hasItem(uid, '灵魂明珠', 1) then
                        dialog.post(uid, questPath, '好像您没有带着灵魂明珠啊！',
                        dialog.link(SYS_EXIT, '结束'))
                        return
                    end
        ...
        [[
            ...
            return
            {
                ...
                npc_wish_done = function(uid, args)
                    dialog.post(uid, questPath, '这灵魂明珠中还有我弟弟的灵魂呢！现在弟弟能够升天到平安的世界中去了，我也就死而无憾了！',
                    dialog.link('npc_ask_brother', '您弟弟也被邪教徒作为牺牲祭祀了啊！'))
                end,
                ...
                npc_absolve = function(uid, args)
                    dialog.post(uid, questPath, '这还不够啊！因为沃玛教主仍然深藏在那沃玛神殿的深处的缘故啊！如果不在那个恶魔找到代替灵魂明珠唤醒他的方法之前除掉他的话，这种悲剧不知还会重新上演多少次呢！',
                    {
                        dialog.link('npc_take_job', '那么就让我去除掉沃玛教主吧！'),
                        dialog.link('npc_decline_job', '既然知道那么您就去除掉沃玛教主吧！'),
                    })
                end,
...
[[
    ...
    setQuestHandler(questName,
    {
        ...
        [SYS_ENTER] = function(uid, args)
            ...
            dialog.post(uid, questPath, '喀儿喀儿，要在更晚之前打破这个恶业的羁绊。',
            dialog.link('npc_ask_alone', '您为什么独自一人在这儿生活呢？'))
        end,
