...
local addMonCo = addmon.monGener( -- 诺玛遗址2层_D1602
{
    ...
    },
    {
        name = '诺玛斧兵',
        loc = {
            {x = 200, y = 200, w = 180, h = 180, count = 70, time = 600, cratio = 0},
        }
    },
    {
        name = '诺玛斧兵8',
        loc = {
            {x = 200, y = 200, w = 180, h = 180, count = 7, time = 600, cratio = 0},
        }
    },
    {
        name = '诺玛突击队长',
    ...
    },
    {
        name = '诺玛装甲兵',
        loc = {
            {x = 200, y = 200, w = 180, h = 180, count = 120, time = 600, cratio = 0},
        }
    },
    {
        name = '诺玛装甲兵8',
        loc = {
            {x = 200, y = 200, w = 180, h = 180, count = 12, time = 600, cratio = 0},
        }
    },
    {
        name = '诺玛骑兵',
