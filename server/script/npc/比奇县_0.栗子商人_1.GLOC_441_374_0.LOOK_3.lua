-- converted from Envir/Market_Def/10ChestnutMarket_Bichon-0.txt
--
...
-- event that is not converted. this NPC is not a merchant: no [Goods], no 购买 and no 出售,
-- only barter, which is why it is not on any npc/include/merchant template
